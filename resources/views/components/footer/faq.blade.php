<div class="w-full sm:w-[80vw] bg-bright-grey grid grid-cols-1 lg:grid-cols-2 lg:grid-row-2 items-center sm:p-10 p-5 sm:rounded-2xl">
    <h1 class="col-start-1 col-end-2 row-start-1 row-end-2 font-extrabold text-center lg:text-start text-4xl sm:text-5xl p-7 sm:p-10"><p class="translate">Any questions?</p><p class="translate">We got you</p></h1>
