<a href="{{ route('main.article.show', ['id' => $article['id']]) }}" class="w-full h-[22rem] bg-no-repeat bg-cover col-start-1 col-end-4 row-start-1 row-end-3 rounded-xl" style="background-image: url('storage/{{ $article['img'] }}')">
